...
public class InterfaceFunctionnel {
    ...
    // des méthodes statiques (ne peut pas etre re-implementer)
    // et des méthodes par défaut. ( si non reimplementer c'est l implementation par defaut qui est executee)
